...
db_dir = os.path.join(base_dir, 'data')  # データベースファイルを格納するディレクトリ
if not os.path.exists(db_dir):  # ディレクトリが存在しない場合に作成
    os.makedirs(db_dir)

database = 'sqlite:///' + os.path.join(db_dir, 'data.sqlite')
# データベースエンジンを作成
